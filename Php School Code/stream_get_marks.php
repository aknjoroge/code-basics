...
//$tablenames= "$exam"._."$form$str"._."$term"._."$year";
$tablenames="form".$form."_".$exam."_".$term."_".$year;
...
echo"<tr> <td colspan='21'> <h4>End Of Stream $str </h4></td> </tr>";
echo"<tr> <td colspan='21'> <hr> </td> </tr>";
